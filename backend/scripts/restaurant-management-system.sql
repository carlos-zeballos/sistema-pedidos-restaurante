...
('admin', '$2b$10$encrypted_password', 'Administrador', 'Sistema', 'admin@restaurant.com', 'ADMIN'),
('mozo1', '$2b$10$encrypted_password', 'Juan', 'Pérez', 'mozo1@restaurant.com', 'MOZO'),
('mozo2', '$2b$10$encrypted_password', 'María', 'García', 'mozo2@restaurant.com', 'MOZO'),
('cocinero1', '$2b$10$encrypted_password', 'Carlos', 'López', 'cocinero1@restaurant.com', 'COCINERO'),
('cocinero2', '$2b$10$encrypted_password', 'Ana', 'Martínez', 'cocinero2@restaurant.com', 'COCINERO'),
('caja1', '$2b$10$encrypted_password', 'Roberto', 'Rodríguez', 'caja1@restaurant.com', 'CAJA'),
('barra1', '$2b$10$encrypted_password', 'Laura', 'Fernández', 'barra1@restaurant.com', 'BARRA'),
('barra2', '$2b$10$encrypted_password', 'Diego', 'González', 'barra2@restaurant.com', 'BARRA');
...
-- ✅ Gestión de usuarios (Mozos, Cocineros, Caja, Barra)
-- ✅ 3 Mesas + 2 Puestos de Barra + 5 Espacios Delivery
-- ✅ Sistema de reservas con confirmación
-- ✅ Gestión completa de pedidos
-- ✅ Sistema de combos personalizables
-- ✅ Estados de pedidos en tiempo real
-- ✅ Historial de cambios de estado
-- ✅ Vistas optimizadas para cocina y gestión
-- ✅ Números de pedido automáticos
-- ✅ Estadísticas de preparación
-- ✅ Índices optimizados
-- ✅ Seguridad con RLS
-- 
-- LISTO PARA USAR EN RESTAURANTE ESTILO KFC
-- =====================================================
