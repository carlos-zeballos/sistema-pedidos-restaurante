-- =========================================
-- FIX: Corregir ambos tipos ENUM (order_status y space_type)
-- =========================================
...
-- Crear versión corregida con cast de ambos ENUMs
...
BEGIN
  -- Conteo total (con cast de ambos ENUMs)
  SELECT COUNT(*)
  INTO v_total
  FROM "Order" o
  ...
  WHERE o."deletedAt" IS NULL
    ...
    AND (p_space_type IS NULL OR p_space_type = '' OR s.type = p_space_type::space_type);
