-- =========================================================
-- CORRECCIÓN DE AMBIGÜEDAD EN LA FUNCIÓN RPC
-- =========================================================
-- El error "column reference 'id' is ambiguous" indica que
-- hay conflicto entre variables locales y nombres de columnas
-- =========================================================
...
-- Crear la función corregida sin ambigüedades
...
BEGIN
  ...
  -- CORRECCIÓN: Usar "Order".id en lugar de solo id para evitar ambigüedad
  INSERT INTO "Order" (
    "spaceId",
    "createdBy",
    "customerName",
