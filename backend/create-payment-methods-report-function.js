...
async function createPaymentMethodsReportFunction() {
  console.log('🔧 Creando función RPC para reporte de métodos de pago...\n');

  try {
    await client.connect();
    console.log('✅ Conexión a base de datos exitosa');

    // 1. Crear la función RPC para reporte de métodos de pago con filtro de fecha
    console.log('1️⃣ CREANDO FUNCIÓN get_payment_methods_report_by_date:');
    console.log('=====================================================');
    ...
    // 2. Crear la función RPC para reporte de pagos de delivery con filtro de fecha
    console.log('\n2️⃣ CREANDO FUNCIÓN get_delivery_payments_report_by_date:');
    console.log('=========================================================');
    ...
    // 3. Crear la función RPC para reporte de órdenes con filtro de fecha
    console.log('\n3️⃣ CREANDO FUNCIÓN get_orders_report_by_date:');
    console.log('===============================================');
    ...
    // 4. Probar las funciones creadas
    console.log('\n4️⃣ PROBANDO FUNCIONES CREADAS:');
    console.log('===============================');
    ...
    console.error('❌ Error creando funciones RPC:', error.message);
  } finally {
    await client.end();
  }
}

createPaymentMethodsReportFunction();
