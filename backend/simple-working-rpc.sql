...
-- =========================================================
-- RPC SIMPLIFICADO Y FUNCIONAL
-- =========================================================
-- Versión que maneja correctamente el casing de orderNumber
-- =========================================================
...
BEGIN
  ...
  -- Insertar cabecera SIN RETURNING para evitar problemas de casing
  INSERT INTO "Order" (
