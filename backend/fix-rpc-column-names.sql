...
-- de columna correctos (snake_case) de la tabla OrderItem
-- =========================================================
...
-- Crear la función corregida con nombres de columna correctos
...
BEGIN
  ...
  -- 5) Insertar los items de la orden con nombres de columna correctos (snake_case)
  FOR v_item IN SELECT * FROM jsonb_array_elements(p_items)
  LOOP
    v_product_id := NULL;
    v_combo_id   := NULL;
    ...
    INSERT INTO "OrderItem" (
      orderid,        -- CORREGIDO: usar snake_case
      productid,      -- CORREGIDO: usar snake_case
      comboid,        -- CORREGIDO: usar snake_case
      name,
      unitprice,      -- CORREGIDO: usar snake_case
      totalprice,     -- CORREGIDO: usar snake_case
      quantity,
      status,
      notes,
      createdat       -- CORREGIDO: usar snake_case
    ) VALUES (
      v_order_id,
      v_product_id,
      v_combo_id,
