...
-- RPC FINAL CORREGIDO
-- =========================================================
-- Corrige los nombres de columnas: orderid, unitprice (lowercase)
-- =========================================================
...
BEGIN
  ...
  -- 5) Insertar items con nombres de columnas correctos (lowercase)
  FOR v_item IN SELECT * FROM jsonb_array_elements(p_items)
  LOOP
    v_product_id := NULL;
    v_combo_id   := NULL;
    ...
    -- CORREGIDO: usar nombres de columnas en lowercase
  ...
  -- 6) Recalcular totales con nombres de columnas correctos
  WITH s AS (
