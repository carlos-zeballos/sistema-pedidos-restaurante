...
-- =========================================================
-- RPC ADAPTADO A LA BASE DE DATOS PROPORCIONADA
-- =========================================================
-- Adaptado para coincidir exactamente con el esquema del usuario
-- =========================================================
...
BEGIN
  ...
  -- Verificar espacio (usando isActive con A mayúscula según el esquema)
  ...
  -- Verificar usuario (usando isActive con A mayúscula según el esquema)
