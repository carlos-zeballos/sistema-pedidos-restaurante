-- =========================================================
-- FIX URGENTE PARA PRECIOS - APLICAR INMEDIATAMENTE
-- =========================================================
-- Este SQL corrige la función RPC para que los precios se almacenen correctamente
-- =========================================================
...
BEGIN
  ...
  -- 5) Insertar items con precios correctos
  FOR v_item IN SELECT * FROM jsonb_array_elements(p_items)
  LOOP
    v_product_id := NULL;
    v_combo_id   := NULL;
