-- =====================================================
-- CORRECCIÓN COMPLETA DE REPORTES
-- Soluciona problemas de métodos de pago, delivery y filtros de fecha
-- =====================================================
...
-- Crear función corregida que maneja correctamente los estados simplificados
...
-- Crear función corregida que incluye TODAS las órdenes
...
-- Crear función corregida que incluye TODAS las órdenes de delivery
...
CREATE INDEX IF NOT EXISTS idx_order_ispaid ON "Order"("isPaid");
...
CREATE INDEX IF NOT EXISTS idx_orderpayment_delivery ON "OrderPayment"("isDeliveryService");
...
SELECT 'VERIFICACIÓN: FUNCIONES CREADAS' as categoria, 'get_orders_report_by_date' as funcion;
SELECT 'VERIFICACIÓN: FUNCIONES CREADAS' as categoria, 'get_payment_methods_report_by_date' as funcion;
SELECT 'VERIFICACIÓN: FUNCIONES CREADAS' as categoria, 'get_delivery_payments_report_by_date' as funcion;
