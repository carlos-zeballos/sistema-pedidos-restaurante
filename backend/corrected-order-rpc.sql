...
-- =========================================================
-- RPC CORREGIDO PARA LA BASE DE DATOS REAL
-- =========================================================
-- Corregido según el diagnóstico del esquema real:
-- - User.isactive (lowercase)
-- - Space.isActive (camelCase)
-- - Product.isEnabled/isAvailable (camelCase)
-- - Order.orderNumber (camelCase)
-- =========================================================
...
BEGIN
  ...
  -- Verificar espacio (usando isActive con A mayúscula según el esquema real)
  ...
  -- Verificar usuario (usando isactive en minúsculas según el esquema real)
  ...
  IF v_order_number IS NULL OR v_order_number = '' THEN
    ...
    SELECT "orderNumber" INTO v_order_number FROM "Order" WHERE id = v_order_id;
  END IF;
